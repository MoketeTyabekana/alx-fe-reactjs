...
function UserProfile() {
    return (
      <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto, my-20 rounded-lg shadow-lg sm:p-4 md:p-8 ms:max-w-xs md:max-w-sm hover:shadow-xl">
        ...
        <h1 className='text-xl text-blue-800 my-4 sm:text-lg md:text-xl sm:text-sm md:text-base hover:text-blue-500'>John Doe</h1>
